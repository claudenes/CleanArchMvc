...
namespace IntegracaoGoogle.Domain.Tests
{
    public class ProductUnitTest1
    {
        ...
        public void CreateProduct_LongImageName_DomainExceptionRequiredImageName()
        {
            ...
            action.Should().Throw<IntegracaoGoogle.Domain.Validation.DomainExceptionValidation>().WithMessage("Invalid image name, too long. maximum 250 characters");
        }
        [Fact]
        ...
        public void CreateCategory_WithNullDescription_DomainExceptionInvalidName()
        {
            ...
            action.Should().Throw<IntegracaoGoogle.Domain.Validation.DomainExceptionValidation>().WithMessage("Invalid description, too short. minimum 3 characters");
        }
    }
}
